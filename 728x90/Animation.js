home_animation = (function() {
	...
	function frame1()
	{
		...
		TweenLite.to(left, 2.5, {top:-232, ease: Linear.easeNone});
		TweenLite.to(right, 2.5, {top:-52, ease: Linear.easeNone});
		TweenLite.delayedCall(2.5, frame2);
	}
	function frame2()
	{	
		TweenLite.to(left, 1, {top:-142, ease: Linear.easeNone});
		TweenLite.to(right, 1, {top:-142, ease: Linear.easeNone});

		TweenLite.to(left, 3, {top:-92, delay:1});
		TweenLite.to(right, 3, {top:-192, delay:1});
		
		TweenLite.delayedCall(3.5, frame3);
	}
	function frame3()
	{
		TweenLite.to(left, 1, {top:-2});
		TweenLite.to(right, 1, {top:-280});
		...
		TweenLite.to(bottle, 2.5, {top:-255, delay: 1.5});
